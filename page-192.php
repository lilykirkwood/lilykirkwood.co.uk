...
<html <?php language_attributes(); ?>>
         ...
         <section id="work">
           <div class="full-width">
             <div class="third-width">
               <img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-html.png" alt="HTML icon"/>
             ...
             <div class="third-width">
               <img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-css.png" alt="CSS icon"/>
             ...
             <div class="third-width">
               <img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-pencil.png" alt="Pencil icon"/>
    ...
    <!-- CONTACT PANEL -->
          <footer id="contact">
            <div class="full-width">
              <div class="half-width">
                <img id="contact-img" src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/contact.png" alt="Person typing at laptop"/>
              </div>
              <div class="half-width" id="contact-info">
                <h2>Like what you see?</h2>
                <h3 id="email-header">Let's meet for a cup of coffee.</h3>
                <a href="mailto:hi@jubileeausten.com"><img id="envelope" src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-envelope.png" alt="mail icon"/>hi@jubileeausten.com</a>
                <h4 id="socialmedia-header">Or, find me on the interwebs</h4>
            <!-- ICON LINKS -->
                <ul>
                  <li><a href="https://twitter.com" target="_blank"><img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-twitter.png" alt="Twitter icon"/></a></li>
                  <li><a href="https://tumblr.com" target="_blank"><img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-tumblr.png" alt="Tumblr icon"/></a></li>
                  <li><a href="https://www.instagram.com/" target="_blank"><img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-instagram.png" alt="Instagram icon"/></a></li>
                  <li><a href="https://www.linkedin.com/" target="_blank"><img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-linkedin.png" alt="Linkedin icon"/></a></li>
                  <li><a href="https://github.com/" target="_blank"><img src="http://lilykirkwood.co.uk/wp-content/uploads/2017/01/icon-github.png" alt="GitHub icon"/></a></li>
                </ul>
              </div>
            </div>
          </footer>
